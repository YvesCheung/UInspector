...
/**
 * @see androidx.compose.ui.graphics.BlockGraphicsLayerModifier
 *
 * @author YvesCheung
 * 2021/12/3
 */
class BlockGraphicsLayerModifierParser(private val modifier: Modifier) : GraphicsLayerModifier() {
    ...
    companion object {
        ...
        private val modifierClass by lazy(LazyThreadSafetyMode.NONE) {
            Class.forName("androidx.compose.ui.graphics.BlockGraphicsLayerModifier")
        }
