...
package com.pitaya.mobile.uinspector.ui.panel.tablayout;
...
import static com.pitaya.mobile.uinspector.ui.panel.tablayout.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;
...
public class TabLayout extends HorizontalScrollView {
  ...
  public TabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    tabTextAppearance = android.R.style.TextAppearance_WindowTitle;
    tabTextColors = createColorStateList(
        res.getColor(android.R.color.white),
        res.getColor(R.color.uinspector_primary_color));
    tabTextSize = res.getDimensionPixelSize(R.dimen.uinspector_design_tab_text_size);
    tabSelectedIndicatorColor = res.getColor(R.color.uinspector_primary_color);
    slidingTabIndicator.setSelectedIndicatorHeight((int) dpToPx(getContext(), 4));
    ...
    tabTextMultiLineSize = res.getDimensionPixelSize(R.dimen.uinspector_design_tab_text_size_2line);
    scrollableTabMinWidth = res.getDimensionPixelSize(R.dimen.uinspector_design_tab_scrollable_min_width);
  ...
  public final class TabView extends LinearLayout {
    ...
    private void updateBackgroundDrawable(Context context) {
      ...
      // }
      ViewCompat.setBackground(this, contentDrawable);
      ...
      this.iconView =
          (ImageView)
              LayoutInflater.from(getContext())
                  .inflate(R.layout.uinspector_design_layout_tab_icon, iconViewParent, false);
    ...
    private void inflateAndAddDefaultTextView() {
      ...
      this.textView =
          (TextView)
              LayoutInflater.from(getContext())
                  .inflate(R.layout.uinspector_design_layout_tab_text, textViewParent, false);
